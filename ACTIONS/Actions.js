...
//* 2.restockCake()
//todo : It accepts the dynamic value so we can update with multiple count.
...
const reducer = (state = initialState, actions) => {
  ...
  switch (actions.type) {
    ...
    case CAKE_RESTOCEKED : return{
        ...state,
        //todo : The actions helps to update the multiple count 
        numOfCakes : state.numOfCakes + actions.quantity
    }
